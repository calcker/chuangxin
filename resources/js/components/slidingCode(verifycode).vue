<template>
    <div class="drag">
        ...
        <p @touchstart="flag && mousedownFn($event)" class="handler handler_bg"></p>
    </div>
</template>
...
import Vue from 'vue';
    export default {
        ...
        mounted(){
            document.addEventListener('touchmove',(e) => {   //拖动，这里需要用箭头函数，不然this的指向不会是vue对象
               if(this.mouseMoveStata){
                    this.endClientX = e.changedTouches[0].clientX;
                    var width = this.endClientX - this.beginClientX;
            ...
            // document.addEventListener('touchend',(e) => {     //鼠标放开
            //     console.log(1)
            //     this.mouseMoveStata = false;
            //     var width = this.endClientX - this.beginClientX;
