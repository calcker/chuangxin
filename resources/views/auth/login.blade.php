...
<form class="form-signin">
  ...
  <input type="password" id="inputPassword" class="form-control" placeholder="@yield('email', trans('auth.password'))" required>
  <div class="checkbox mb-3">
    <label>
      <input type="checkbox" value="remember-me"> @yield('email', trans('auth.remember'))
    </label>
  </div>
